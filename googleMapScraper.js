...
app.get('/', (req, res) => {
    ...
    let scrape = async () => { // Prepare scrape...
        ...
        try {
            await page.waitForSelector('.ODSEW-ShBeI-title').catch(error => console.log('failed to wait for the selector'));

            const result = await page.evaluate(() => { // Let's create variables and store values...

                //title
                let titleClasses = document.querySelectorAll("#pane > div > div.widget-pane-content.cYB2Ge-oHo7ed > div > div > div.x3AX1-LfntMc-header-title > div.x3AX1-LfntMc-header-title-ma6Yeb-haAclf > div.x3AX1-LfntMc-header-title-ij8cu > div:nth-child(1) > h1 > span:nth-child(1)");
                let title = [];
                ...
                //subtitle
                let title2Classes = document.getElementsByClassName('x3AX1-LfntMc-header-title-VdSJob');
                let title2 = [];
                ...
                //Address
                let addressContentClasses = document.querySelectorAll('[data-tooltip="Copy address"]');
                let addressContent = []
                ...
                //website
                let websiteContentClasses = document.querySelectorAll('[data-tooltip="Open website"]');
                let websiteContent = []
                ...
                //Phone
                let phoneContentClasses = document.querySelectorAll('[data-tooltip="Copy phone number"]');
                let phoneContent = []
                ...
                //features
                let featuresClasses = document.getElementsByClassName('uxOu9-sTGRBb-p83tee-haAclf');
                let features = [];
                ...
                //Review Count
                let reviewCountClasses = document.getElementsByClassName('gm2-button-alt HHrUdb-v3pZbf');
                let reviewCount = [];
                ...
                //timeTable
                let timeTableClasses = document.querySelectorAll('[data-tooltip="Copy open hours"]');
                let timeTable = [];
                ...
                //testimonial
                let testimonialClasses = document.getElementsByClassName('goAFp-ShBeI-lvvS4b-RWgCYc');
                let testimonial = [];
                ...
                let authorImageValueClasses = document.getElementsByClassName('ODSEW-ShBeI-t1uDwd-HiaYvf');
                ...
                let reviewerImageClasses = document.getElementsByClassName('ODSEW-ShBeI-t1uDwd-HiaYvf');
                let reviewerImage = []
                ...
                let imageClasses = document.getElementsByClassName('a4izxd-tUdTXb-xJzy8c-haAclf-xJzy8c');
                let image = []
                ...
                let imageNameClasses = document.getElementsByClassName('a4izxd-tUdTXb-xJzy8c-haAclf');
                let imageName = []
...
app.get('/search', (req, res) => {
    ...
    let scrape = async () => { // Prepare scrape...
        ...
        await page.waitFor(5000);
        try {
            await page.waitForSelector('.a4gq8e-aVTXAb-haAclf-jRmmHf-hSRGPd').catch(error => console.log('failed to wait for the selector'));;

            const result = await page.evaluate(() => { // Let's create variables and store values...

                //title
                let titleClasses = document.getElementsByClassName('a4gq8e-aVTXAb-haAclf-jRmmHf-hSRGPd');
                let title = [];
                ...
                //Url
                let urlClasses = document.getElementsByClassName('a4gq8e-aVTXAb-haAclf-jRmmHf-hSRGPd');
                let url = [];
